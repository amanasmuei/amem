#!/usr/bin/env node
// amem sessionEnd hook — auto-summarizes session from conversation log
...
try {
  ...
  ).run(randomUUID(), sessionId, 'system', '[SESSION_END]', now, project, JSON.stringify({ hook: 'sessionEnd' }));
